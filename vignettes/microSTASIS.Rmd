...
mS_TSE <- iterativeClustering(pairedTimes = TSE_times, parallel = TRUE, 
                              common = "_")
```
...
```{r, echo = FALSE}
image <- "https://github.com/BiotechPedro/microSTASIS/tree/main/man/figures/mSerrorCV_plot.png"
cat(paste0('<center><img src="', image,  '"></center>')) 
```
...
```{r, echo = FALSE}
image <- "https://github.com/BiotechPedro/microSTASIS/tree/main/man/figures/mSlinesCV_output.png"
cat(paste0('<center><img src="', image,  '"></center>')) 
```
