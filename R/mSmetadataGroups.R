...
#' @param ID If TreeSummarizedExperiment, one of the colData(data) colnames
#'         should be given as individuals.
#' @param timePoints If TreeSummarizedExperiment, one of the colData(data) 
#'         colnames should be given as sampling times.
#' @param TreeSummarizedExperiment TRUE if colData(data), or 
#'         colData(altExp(data)), passed as metadata.
#'
